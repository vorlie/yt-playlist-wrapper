...
DATABASE_DIR = os.path.dirname(__file__)  # noqa: PTH120
DATABASE_PATH = os.path.join(DATABASE_DIR, "..", "app_data.db")  # noqa: PTH118
...
async def get_user_by_username(username: str) -> Optional[Dict[str, Any]]:  # noqa: UP006
